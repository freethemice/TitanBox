...
public enum ItemEnum {
    ...
    PLACERPUMP(-7, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZWNiNzE5M2FkYWEwMzg2YjNjYjMzN2EzODIyYzFhOGRhZTVhOTU3ZWIxZjFhMzc0ZTAwNDc5ZjEwMDBjZTJmOSJ9fX0="),
    ...
    NETWORK(-10, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjE2NzcyNmI2YTIwYTFmMTc4NGE5ZjM2OGM4NTI2NWZiOTQ0ODRlNGI1YmIwYTFlOTcwNjFiZWE4MzU2OTUifX19");

    private final int size;
    private final String texute;
    private final ItemStack item;

    ItemEnum(int size, String texute)
    {
        this.size = size;
        this.texute = texute;
        this.item = Utilities.getSkull(texute);
    }
    public static ItemEnum getBySize(int size)
    {
        for (ItemEnum ih: ItemEnum.values())
        {
            if (ih.size == size)
            {
                return ih;
