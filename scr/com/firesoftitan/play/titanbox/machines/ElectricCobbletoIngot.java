        ...
        if (isProcessing(b)) {
            ...
            for (int slot: getInputSlots()) {
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), new ItemStack(Material.COBBLESTONE, 8), true)) {
                    ...
                    if (SlimefunStartup.chance(100, 25)) adding = me.mrCookieSlime.Slimefun.Lists.SlimefunItems.GOLD_4K;
                    else if (SlimefunStartup.chance(100, 25)) adding = me.mrCookieSlime.Slimefun.Lists.SlimefunItems.ALUMINUM_INGOT;
                    else if (SlimefunStartup.chance(100, 25)) adding = me.mrCookieSlime.Slimefun.Lists.SlimefunItems.COPPER_INGOT;
                    else if (SlimefunStartup.chance(100, 25)) adding = me.mrCookieSlime.Slimefun.Lists.SlimefunItems.ZINC_INGOT;
                    else if (SlimefunStartup.chance(100, 25)) adding = me.mrCookieSlime.Slimefun.Lists.SlimefunItems.TIN_INGOT;
