        ...
        try {
            if (ChargableBlock.isChargable(b)) {
                ...
                if (SlimefunManager.isItemSimiliar(WhatAmIDoing.getInput()[0], me.mrCookieSlime.Slimefun.Lists.SlimefunItems.REACTOR_COOLANT_CELL, true)) {
                    if (SlimefunStartup.chance(2000, 2)) adding = SlimefunItemsHolder.VOID_PARTICLES.clone();
                    else if (SlimefunStartup.chance(3000, 3)) adding = SlimefunItemsHolder.BEDROCK_DUST.clone();
                    else if (SlimefunStartup.chance(3000, 1) && b.getLocation().getWorld().getName().contains("world")) adding = SlimefunItemsHolder.VOID_PARTICLES_POSITIVE.clone();
                    else if (SlimefunStartup.chance(3000, 1) && b.getLocation().getWorld().getName().contains("world")) adding = SlimefunItemsHolder.VOID_PARTICLES_NEGATIVE.clone();
