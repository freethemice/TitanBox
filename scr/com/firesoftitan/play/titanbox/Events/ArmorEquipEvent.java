package com.firesoftitan.play.titanbox.Events;
...
public final class ArmorEquipEvent extends PlayerEvent implements Cancellable{
     ...
     */
    public ArmorEquipEvent(final Player player, final EquipMethod equipType, final ArmorTypeEnum type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
        super(player);
        this.equipType = equipType;
        this.type = type;
        this.oldArmorPiece = oldArmorPiece;
        this.newArmorPiece = newArmorPiece;
        if (this.oldArmorPiece != null) {
            if (this.oldArmorPiece.getType() == Material.AIR || this.oldArmorPiece.getType() == Material.CAVE_AIR) {
                this.oldArmorPiece = null;
            }
        }
        if (this.newArmorPiece != null) {
            if (this.newArmorPiece.getType() == Material.AIR || this.newArmorPiece.getType() == Material.CAVE_AIR) {
                this.newArmorPiece = null;
            }
        }
    }
    ...
    public final ArmorTypeEnum getType(){
        return type;
    }
