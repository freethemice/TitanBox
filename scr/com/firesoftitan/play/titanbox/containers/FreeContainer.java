...
public abstract class FreeContainer extends TitanItemManager {
    ...
    public FreeContainer(Category category, ItemStack item, final String name, RecipeType recipeType, ItemStack[] recipe) {
        super(category, item, name, recipeType, recipe);
        BlockMenuPreset var10001 = new BlockMenuPreset(name, this.getInventoryTitle()) {
            public void init() {
                FreeContainer.this.constructMenu(this);
            }
            ...
            public int[] getSlotsAccessedByItemTransport(ItemTransportFlow flow) {
                return flow.equals(ItemTransportFlow.INSERT)?FreeContainer.this.getInputSlots():FreeContainer.this.getOutputSlots();
            }
        ...
        registerBlockHandler(name, new SlimefunBlockHandler() {
            ...
            public boolean onBreak(Player p, Block b, SlimefunItem item, UnregisterReason reason) {
                ...
                if(inv != null) {
                    int[] var6 = FreeContainer.this.getInputSlots();
                    ...
                    var6 = FreeContainer.this.getOutputSlots();
                    var7 = var6.length;
                ...
                FreeContainer.progress.remove(b);
                FreeContainer.processing.remove(b);
                return true;
            }
        });
    ...
    public FreeContainer(Category category, ItemStack item, final String name, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {
        ...
        registerBlockHandler(name, new SlimefunBlockHandler() {
            ...
            public boolean onBreak(Player p, Block b, SlimefunItem item, UnregisterReason reason) {
                int[] var5 = FreeContainer.this.getInputSlots();
                ...
                var5 = FreeContainer.this.getOutputSlots();
                var6 = var5.length;
