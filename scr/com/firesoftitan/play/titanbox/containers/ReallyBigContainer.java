...
public abstract class ReallyBigContainer extends TitanItemManager {
	...
	private static final int[] border = {5, 14, 32, 41};
	private static final int[] border_in = {};
	private static final int[] border_out = {6, 7, 8, 15, 24, 33, 42, 43, 44, 35, 26, 17};

	public ReallyBigContainer(Category category, ItemStack item, String id, RecipeType recipeType, ItemStack[] recipe) {
	...
	public ReallyBigContainer(Category category, ItemStack item, String id, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {
	...
	protected void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(23, new CustomItem(new ItemStack(Material.BLACK_STAINED_GLASS_PANE), " "),
		new MenuClickHandler() {
	...
	public int[] getInputSlots() {
		return new int[] {0, 1, 2, 3, 4, 9, 10, 11, 12, 13, 18, 19, 20 ,21, 22, 27, 28, 29, 30, 31, 36, 37, 38, 39, 40};
	}
	
	public int[] getOutputSlots() {
		return new int[] {16, 25, 34};
	}
	...
	public void register(boolean slimefun) {
		addItemHandler(new BlockTicker() {
			...
			public void tick(Block b, SlimefunItem sf, Config data) {
				ReallyBigContainer.this.tick(b);
			}
